    ...
    <form method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
    	...
    	<table class="form-table">
			<tbody>
				...
				<tr>
					<th scope="row" valign="top">LDAP Admin CN</th>
					<td>
						<input type="text" name="<?php echo $this->get_field_name('admin_cn'); ?>" value="<?php echo $SimpleLDAPLogin->get_setting('admin_cn'); ?>" /><br/>
						Only applies to Open LDAP. (For user creation and update).
					</td>
				</tr>
				<tr>
					<th scope="row" valign="top">LDAP Admin Password</th>
					<td>
						<input type="password" name="<?php echo $this->get_field_name('admin_password'); ?>" value="<?php echo $SimpleLDAPLogin->get_setting('admin_password'); ?>" /><br/>
						Only applies to Open LDAP. (For user creation and update).
					</td>
				</tr>
